...
- [핵심 아키텍처](#핵심-아키텍처)
  - [1. 모노레포 구조](#1-모노레포-구조)
  - [2. 패키지 시스템](#2-패키지-시스템-packagesclaudecode)
  - [3. CLI 시스템](#3-cli-시스템-cli)
  - [4. 템플릿 생성 엔진](#4-템플릿-생성-엔진)
- [컴포넌트 아키텍처](#컴포넌트-아키텍처)
  - [AI 에이전트 시스템](#ai-에이전트-시스템)
  - [명령어 시스템](#명령어-시스템)
  - [워크플로우 시스템](#워크플로우-시스템)
- [SDLC 파이프라인 아키텍처](#sdlc-파이프라인-아키텍처)
- [PRD 시스템 아키텍처](#prd-시스템-아키텍처)
- [문서 아키텍처](#문서-아키텍처)
- [보안 아키텍처](#보안-아키텍처)
- [성능 최적화](#성능-최적화)
- [확장 포인트](#확장-포인트)
...
- **통합**: `../api/agents.md`를 통한 직접 Claude Code 인식
