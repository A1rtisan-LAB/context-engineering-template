...
description: Implement new features, components, or code functionality with intelligent expert persona activation and MCP integration support.
---

# Feature Implementation Command

Implement new feature: $ARGUMENTS with production-ready code and comprehensive testing.
