---
allowed-tools: [Read, Glob, Grep, MultiEdit, TodoWrite, Edit, Write]
description: Systematic improvements to existing code, including refactoring for better performance, maintainability, readability, or adherence to best practices.
---

# Code Enhancement Command

Enhance and improve existing code in $ARGUMENTS with systematic refactoring and modern best practices.
