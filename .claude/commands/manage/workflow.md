---
allowed-tools: [TodoWrite, Task, Read, mcp__sequential-thinking__sequentialthinking]
description: Execute complex, multi-step tasks with intelligent workflow management, cross-session persistence, and hierarchical task organization for enterprise-level projects.
---

# Workflow Orchestration Command

Orchestrate long-term workflow for $ARGUMENTS with intelligent dependency tracking and cross-session project management.
